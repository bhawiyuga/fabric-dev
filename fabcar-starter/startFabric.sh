...
rm -rf fabcar/javascript/wallet/*
rm -rf fabcar/java/wallet/*
rm -rf fabcar/typescript/wallet/*
...
./network.sh deployCC -ccn fabcar -ccv 1.0 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
